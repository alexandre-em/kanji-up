...
export type SketchPropsType = {
  visible: boolean;
  color: string;
  style?: any;
};

export default forwardRef(({ visible, color, style }: SketchPropsType, ref) => {
  ...
  return (
    <View ref={divRef as any} style={styles.body}>
      <Surface elevation={4}>
        <View style={[styles.canvas, { width: w, height: w }, style]} {...canvasPlatformProps}>
