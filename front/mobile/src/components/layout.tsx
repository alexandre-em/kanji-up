...
export default function Layout({ screen, withTabBar, children }: LayoutProps & PropsWithChildren) {
  ...
  return (
    <Animated.ScrollView
      ...
      contentContainerStyle={{ paddingBottom: tabBarClearance + GENERAL_MARGIN }}
      onScroll={handleScroll}
      scrollEventThrottle={16}>
      <View style={{ minHeight: height - headerHeight - tabBarClearance }}>
        <Spacing y={20} />
