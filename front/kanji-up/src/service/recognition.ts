...
export default class kanjiService {
  ...
  postRecognition(kanji: string, predictions: { confidence: number, prediction: string }[], image: string, options?: AxiosRequestConfig): Promise<AxiosResponse<RecognitionType>> {
